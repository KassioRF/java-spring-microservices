 ...
 * the
 * application is correctly configured and operational. It does not perform any
 * in-depth
...
public class HealthCheckController {
    ...
    /**
     * Root endpoint for health check. Returns a simple message indicating that the
     * service is
     * operational.
     * 
     * Example response:
    ...
    public ResponseEntity<Map<String, String>> healthCheck() {
        return ResponseEntity.ok(Map.of("message", "Sales Service is up and running"));
    }
}
